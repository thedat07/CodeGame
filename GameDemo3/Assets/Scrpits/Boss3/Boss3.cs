...
public class Boss3 : MonoBehaviour
{
    ...
    [Header("Attack1")]
    public float attack1MovementSpeed;
    public Vector2 attack1MovementDirection;
    [SerializeField]
    private int bulletsAmount = 5;
    [SerializeField]
    private float startAngle = 0f, endAngle = 180f;
    [Header("Other")]
    ...
    public void Attack1State()
    {
        ...
        enemyRB.velocity = attack1MovementSpeed * attack1MovementDirection;
    }
